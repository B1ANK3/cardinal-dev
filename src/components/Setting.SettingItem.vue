<template>
	<div class="setting-item">
		<div class="contents">
			...
			<div
				class="description-bool"
				v-else
			>
				<div class="bool-control">
					<div
						class="checkbox"
						@click="toggle_checkbox($event)"
					></div>
				</div>
			...
			<div
				class="deprecated-msg"
				:class="setting.deprecated ? '' : 'hide'"
			>
...
export default defineComponent({
	...
	methods: {
		...
		isDefaultValue(
			val1: string | boolean | number | DropdownValue,
			val2: string | boolean | number | DropdownValue
		) {
			let res =
				(typeof val1 == 'string' &&
					typeof val2 == 'string' &&
